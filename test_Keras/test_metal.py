...
#print('Accuracy: %.4f' % (evaluation*100))
...
plt.plot(i, y[:10], color='blue', marker='o', label='raw data')
plt.plot(i, predictions[:10], color='red', marker='o', label='prediction ')
plt.legend()
plt.savefig("metal2.png")

#dataset2 = loadtxt('total_data_TPPonly.txt', delimiter=',')
